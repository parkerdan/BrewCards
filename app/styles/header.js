...
export const recipeIcon = {name:'flask',size:20,color:colors.watermelon, style: header.margin}
export const closeIcon = {name:'close',size:20,color:colors.watermelon,style:header.margin}
